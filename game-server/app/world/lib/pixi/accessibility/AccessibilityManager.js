...
AccessibilityManager.prototype.activate = function()
{
	...
	global.document.addEventListener('mousemove', this._onMouseMove, true);
	global.removeEventListener('keydown', this._onKeyDown, false);
...
AccessibilityManager.prototype.deactivate = function()
{
	...
	global.document.removeEventListener('mousemove', this._onMouseMove);
	global.addEventListener('keydown', this._onKeyDown, false);
