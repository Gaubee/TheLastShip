...
InteractionManager.prototype.addEvents = function ()
{
    ...
    global.document.addEventListener('mousemove',    this.onMouseMove, true);
    ...
    global.addEventListener('mouseup',  this.onMouseUp, true);
...
InteractionManager.prototype.removeEvents = function ()
{
    ...
    global.document.removeEventListener('mousemove', this.onMouseMove, true);
    ...
    global.removeEventListener('mouseup',  this.onMouseUp, true);
