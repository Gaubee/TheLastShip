...
declare namespace PIXI {
    ...
    export class Graphics extends Container {
        ...
        clone(): Graphics;
        lineStyle(lineProton?: number, color?: number, alpha?: number): Graphics;
    ...
    export module extras {
        ...
        export class TilingSprite extends Sprite {
            ...
            //Thanks bas!
            static fromFrame(frameId: string): TilingSprite;
            static fromImage(imageId: string, crossorigin?: boolean, scaleMode?: number): TilingSprite;
    ...
    namespace filters {
        ...
        export class BlurDirFilter extends AbstractFilter {
            dirX: number;
            dirY: number;
        }
    ...
    export module mesh {
        ...
        export class Mesh extends Container {
            ...
            constructor(texture: Texture, vertices?: number[]|Float32Array, uvs?: number[]|Float32Array, indices?: number[]|Float32Array, drawMode?: number);
